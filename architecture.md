...
- `shared`: branded IDs and schema-v4 contracts for nodes, revisions, checkpoints, assets, derived topology, collaboration messages, and API payloads.
- `document-core`: immutable document operations, feature ordering, parameter expression evaluation, editable STEP features, finishing/pattern features, legacy-to-v4 document migration, and checkpoint creation.

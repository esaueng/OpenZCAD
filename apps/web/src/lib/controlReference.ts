...
export const POINTER_CONTROL_GROUPS = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        keys: ['Double-click'],
        action: 'Fit the view',
        detail: 'Frames visible geometry unless an edge run is selected.'
      }
    ]
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail: 'Keeps the existing body or topology selection.'
      },
      {
        id: 'window-select',
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'fine-drag',
        keys: ['Shift + handle drag'],
        action: 'Use fine or unsnapped movement',
        detail:
          'Bypasses normal snapping; edge edits use finer hundredth steps.'
      },
      {
        id: 'exact-entry',

...
/**
 * Chooses a conventional 1/2/5 × 10ⁿ scale that never exceeds the requested
 * screen width. The lower bound is implicit in the sequence: adjacent steps
 * differ by at most 2.5×, so a 200px ceiling keeps the bar above 80px.
 */
